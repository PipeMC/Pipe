...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient {
	...
	/**
	 * Gets the players total experience points. <br>
	 * This refers to the total amount of experience the player has collected over
	 * time and is only displayed as the player's "score" upon dying.
	 *
	...
	/**
	 * Sets the players current experience points. <br>
	 * This refers to the total amount of experience the player has collected over
	 * time and is only displayed as the player's "score" upon dying.
	 *
	 * @param exp
	 ...
	 * the past, it will perform a file size check against the response content to
	 ...
	 * method will have no affect on them. Use the
	 * {@link PlayerResourcePackStatusEvent} to figure out whether or not the player
	 * loaded the pack!
	 * <li>There is no concept of resetting texture packs back to default within
	 * Minecraft, so players will have to relog to do so or you have to send an
	 * empty pack.
	 * <li>The request is send with "null" as the hash. This might result in newer
	 * versions not loading the pack correctly.
	 * </ul>
	 *
	 * @param url
	 ...
	 * The player's client will download the new resource pack asynchronously in the
	 * background, and will automatically switch to it once the download is
	 * complete. If the client has downloaded and cached a resource pack with the
	 * same hash in the past it will not download but directly apply the cached
	 * pack. When this request is sent for the very first time from a given server,
	 * the client will first display a confirmation GUI to the player before
	 ...
	 *            as per RFC 1738.
	 * @param hash
	 *            The sha1 hash sum of the resource pack file which is used to apply
	 *            a cached version of the pack directly without downloading if it is
	 *            available. Hast to be 20 bytes long!
	 * @throws IllegalArgumentException
	 *             Thrown if the URL is null.
	 * @throws IllegalArgumentException
	 *             Thrown if the URL is too long. The length restriction is an
	 ...
	 *
	 * @param entity
	 *            the entity to follow or null to reset
	 * @throws IllegalStateException
	 *             if the player is not in {@link GameMode#SPECTATOR}
	 */
	 ...
	 * contain a new line, only the first line will be sent. The titles will be
	 * displayed with the client's default timings.
	 *
	 * @param title
	 *            Title text
	 * @param subtitle
	...
	/**
	 * Resets the title displayed to the player. This will clear the displayed title
	 * / subtitle and reset timings to their default values.
	 */
	public void resetTitle();

	/**
	 * Spawns the particle (the number of times specified by count) at the target
	 * location.
	 *
	 * @param particle
	 ...
	 *            the number of particles
	 * @param data
	 *            the data to use for the particle or null, the type of this depends
	 *            on {@link Particle#getDataType()}
	 */
	...
	/**
	 * Spawns the particle (the number of times specified by count) at the target
	 * location. The position of each particle will be randomized positively and
	 * negatively by the offset parameters on each axis.
	 *
	 * @param particle
	 *            the particle to spawn
	 * @param location
	 ...
	 *            the maximum random offset on the Z axis
	 * @param extra
	 *            the extra data for this particle, depends on the particle used
	 *            (normally speed)
	 */
	public void spawnParticle(Particle particle, Location location, int count, double offsetX, double offsetY,
	 ...
	 *
	 * The value of the locale String is not defined properly. <br>
	 * The vanilla Minecraft client will use lowercase language / country pairs
	 * separated by an underscore, but custom resource packs may use any format they
	 * wish.
	 *
